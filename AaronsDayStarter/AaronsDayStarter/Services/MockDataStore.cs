...
namespace AaronsDayStarter.Services
{
    public class MockDataStore : IDataStore<Item>
    {
        ...
        public MockDataStore()
        {
            ...
            {
                new Item {Id = Guid.NewGuid().ToString(), Stage="Opening", Day="Every", Content="O Lord, Let my soul rise up to meet you, as the day rises to meet the sun."},
                ...
                new Item { Id = Guid.NewGuid().ToString(), Stage="Daily Prayer", Day = "Monday",
                    Content ="My Lord God, I have no idea where I am going. \nI do not see the road ahead of me. \n" +
                ...
                new Item { Id = Guid.NewGuid().ToString(), Stage="Daily Prayer", Day = "Tuesday",
                    Content ="Soul of Christ, annctify me, Body of Christ, save me. \n" +
